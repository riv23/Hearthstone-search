	...
	public void addToSearch(CardType cardType, TypesEnum type) {
		...
		switch (type) {
			case BASIC:
                ...
                dataStoreService.putIntoDataStore(basics);
                break;
			case CLASSIC:
                ...
                dataStoreService. putIntoDataStore(classics);
				break;
			case CURSE_OF_NAXXRAMAS:
                ...
                dataStoreService.putIntoDataStore(curseOfNaxxramass);
				break;
			case GOBLINS_VS_GNOMES:
                ...
                dataStoreService.putIntoDataStore(gobelinsVsGnomes);
				break;
			case PROMOTION:
                ...
                dataStoreService.putIntoDataStore(promotions);
				break;
			default:
				break;
		}
